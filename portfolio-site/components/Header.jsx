        ...
        <div className="flex h-16 items-center justify-between md:h-20">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <button
              ...
              className="ml-2 px-4 py-2 text-sm font-medium bg-primary text-primary-foreground rounded-lg hover:opacity-90 transition-opacity cursor-pointer"
            >
              Get in touch
            </button>
          </div>
            ...
            <div className="px-6 py-6 flex flex-col gap-4">
              ...
              <div className="flex items-center gap-4 pt-4 border-t border-border/50">
                ...
                <button
                  ...
                  className="ml-auto px-4 py-2 text-sm font-medium bg-primary text-primary-foreground rounded-lg hover:opacity-90 transition-opacity cursor-pointer"
                >
                  Get in touch
                </button>
              </div>
